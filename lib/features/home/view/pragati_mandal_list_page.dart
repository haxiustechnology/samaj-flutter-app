...
import '../../../data/models/pragati_mandal_model.dart';
import '../bloc/guest_bloc.dart';

class PragatiMandalListPage extends StatelessWidget {
  const PragatiMandalListPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          S.of(context).pragatiMandalList,
            ...
            if (state is GuestLoading) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final PragatiMandalModel item = list[index];
                  return Padding(
