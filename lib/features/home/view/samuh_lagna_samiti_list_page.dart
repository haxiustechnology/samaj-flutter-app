...
import '../../../data/models/samuh_lagna_samiti_model.dart';
import '../bloc/guest_bloc.dart';

class SamuhLagnaSamitiListPage extends StatelessWidget {
  const SamuhLagnaSamitiListPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          S.of(context).samuhLagnaSamitiList,
            ...
            if (state is GuestLoading) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // Safe cast if the BLoC loaded list items as dynamic/generic
                  final SamuhLagnaSamitiModel member = item as SamuhLagnaSamitiModel;
                  return Padding(
