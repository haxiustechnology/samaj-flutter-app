...
import '../../../data/models/shikshan_samiti_model.dart';
import '../bloc/guest_bloc.dart';

class ShikshanSamitiListPage extends StatelessWidget {
  const ShikshanSamitiListPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          S.of(context).shikshanSamitiList,
            ...
            if (state is GuestLoading) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final ShikshanSamitiModel item = list[index];
                  return Padding(
